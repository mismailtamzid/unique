    ...
    <Row className="me-0 px-0">
      <Col md={3} className="px-0">
        <Navbar collapseOnSelect expand="md">
          <Container className="d-flex flex-column dashboard-route">
            <Navbar.Brand
              className="text-dark me-auto fs-2 fw-bold"
              href="/home"
            >
              UNIQUE<span className="text-danger">SHOP</span>
            </Navbar.Brand>
            <hr className="w-100 bg-white" />

            <Navbar.Text className="text-dark my-1 fs-4 text-start me-auto">
              <FontAwesomeIcon className="text-dark" icon={faColumns} />{" "}
              Dashboard
            </Navbar.Text>

            <Navbar.Toggle
              className="me-auto text-start"
            ...
            >
              <Nav className="d-flex flex-column fs-6">
                ...
                >
                  <FontAwesomeIcon icon={faFileInvoice} /> Payment
                </Nav.Link>
                <br />
                {/* </>} */}
                {admin && (
                  <div>
                    ...
                    >
                      <FontAwesomeIcon icon={faFolderPlus} /> Add A Product
                    </Nav.Link>
                    <br />
                    <Nav.Link
                      className="text-dark fw-bold"
      ...
      <Col md={9} className="px-0">
        <Breadcrumb className="my-4  ms-3 home-Breadcrumb">
          <Breadcrumb.Item href="/home" className="fs-4 ">
            Home
          </Breadcrumb.Item>
